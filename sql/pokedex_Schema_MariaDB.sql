...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pokedexx_Pokedex`.`StandardView` (`Type1` INT, `Type2` INT, `Description` INT, `evoNo` INT);

-- -----------------------------------------------------
-- Placeholder table for view `pokedexx_Pokedex`.`AdvancedView`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pokedexx_Pokedex`.`AdvancedView` (`Type1` INT, `Type2` INT, `Description` INT, `Size` INT, `Weight` INT, `evoNo` INT);
